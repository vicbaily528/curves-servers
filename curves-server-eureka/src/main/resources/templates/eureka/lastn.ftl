...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    ...
    <title>服务注册中心 - 最后N的租赁</title>
    <link rel="stylesheet" type="text/css" href="eureka/css/wro.css">
  </head>
  <body id="three">

    <!--[if lt IE 7]>
      <p>你正在使用<strong>过时的</strong> 浏览器。请升级您的浏览器以提高您的体验。</p>
    <![endif]-->
    ...
    <div id="xd-jobs" class="tab-pane active col-md-12">
        <ul class="nav nav-tabs" role="tablist" id="myTab">
          <li class="active"><a data-toggle="tab" href="#cancelled">最后1000个取消租赁</a></li>
          <li><a data-toggle="tab" href="#registered">最近1000宗新注册租约</a></li>
        </ul>
